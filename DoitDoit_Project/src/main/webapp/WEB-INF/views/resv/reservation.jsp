...
<script type="text/javascript" src="./js/cald/timeLine.js"></script>
						...
						<form action="./calInsert.do" method="post" id="frm">
							<div>
								...
								<select id="res" name="resv_room_id" style="display:inline">
									...
									<option value="4">회의실 D</option>
									<option value="5">회의실 E</option>
								</select>
							</div><br>
							
							<div style="margin-top: 10px;">
								<b>일정 시작일 : </b>
								<input type="text" name="resv_start" id="datetimepicker1" readonly="readonly" ondblclick="return false">
								<b>일정 종료일 : </b>
								<input type="text" name="resv_end" id="datetimepicker2" readonly="readonly">
							</div>
							<div>
				            ...
				            <div class="modal-body">
				                <form id="modalFrm">
				                    <div class="form-group">
				                        ...
				                        <label>일정 종료일:</label>
				                        <input type="text" name="resv_end" class="form-control" id="datetimepicker2_2" readonly>
				                    </div>
				                </form>
				            </div>
				            <!-- Modal footer -->
